...
export var BESTIARY_INFO = {
  ...
  weblord: { cat: "boss", desc: "열두 번째 보스. 체력 문턱마다 거미줄을 터뜨려 반경 안 플레이어 전원을 잠시 제자리에 묶는다 — 공격·채집은 그대로 할 수 있다." },
  splitlord: { cat: "boss", desc: "열세 번째 보스. 체력이 다 떨어져도 사라지지 않고 더 약한 두 마리로 갈라져 계속 싸운다 — 진짜 끝은 그 둘까지 마저 처치해야 온다." },
  // ── 변종 (몬스터에 붙는 접두사) ──
  ...
  hawk: { cat: "wild", desc: "유일하게 하늘을 나는 사냥감(5웨이브부터) — 도망 반경이 가장 길어 가장 접근하기 어렵다. 길들이면 유일한 원거리 동료가 된다." },
