...
export var CFG = {
  ...
  builds: {
    ...
    arrow: {
      ...
      levels: [
        { hp: 180, dmg: 11, range: 13, rate: 1.15, mag: 40 },
        { hp: 280, dmg: 18, range: 14.5, rate: 1.35, mag: 60, cost: { wood: 40, stone: 30 } },
        { hp: 420, dmg: 29, range: 16, rate: 1.6, mag: 85, cost: { wood: 80, stone: 70, iron: 6 } }
      ]
    },
    frost: {
      name: "서리탑",
      ...
      levels: [
        { hp: 200, dmg: 5, range: 10, rate: 0.9, slow: 0.45, slowTime: 1.6, mag: 32 },
        { hp: 320, dmg: 9, range: 11.5, rate: 1, slow: 0.55, slowTime: 2, mag: 46, cost: { wood: 30, stone: 55 } },
        { hp: 480, dmg: 14, range: 13, rate: 1.1, slow: 0.65, slowTime: 2.4, mag: 62, cost: { wood: 60, stone: 110, iron: 5 } }
      ]
    },
    cannon: {
      name: "대포탑",
      ...
      levels: [
        { hp: 240, dmg: 26, range: 15, rate: 0.55, splash: 3.2, mag: 18 },
        { hp: 380, dmg: 42, range: 16.5, rate: 0.62, splash: 3.6, mag: 26, cost: { wood: 60, stone: 80 } },
        { hp: 560, dmg: 66, range: 18, rate: 0.7, splash: 4.2, mag: 36, cost: { wood: 120, stone: 160, iron: 8 } }
      ]
    },
    poison: {
      name: "독탑",
      ...
      levels: [
        { hp: 190, dmg: 4, range: 11, rate: 0.8, poisonDps: 6, poisonTime: 3, mag: 30 },
        { hp: 300, dmg: 6, range: 12.5, rate: 0.9, poisonDps: 10, poisonTime: 3.5, mag: 42, cost: { wood: 40, stone: 70 } },
        { hp: 460, dmg: 9, range: 14, rate: 1, poisonDps: 16, poisonTime: 4, mag: 58, cost: { wood: 80, stone: 140, iron: 6 } }
      ]
    },
    support: {
      name: "보루",
